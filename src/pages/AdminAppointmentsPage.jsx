...
const AdminAppointmentsPage = ({ currentUser, userData }) => {
  ...
  const loadData = async () => {
    try {
      setLoading(true);
      const [appointmentsData, staffData, specializationsData] =
        await Promise.all([
          getAllAppointments(),
          getStaff(),
  ...
  const handleConfirmAppointment = async (appointmentId) => {
    const confirmed = await showConfirm(
      "هل أنت متأكد من تأكيد هذا الموعد؟",
      "تأكيد الموعد",
      "تأكيد",
      "إلغاء"
    );
      ...
      <div className="aap-appointments-stats">
        <div className="aap-stat-card">
          <div className="aap-stat-icon">
            <i className="fas fa-calendar-alt" style={{color: "var(--white)"}}></i>
          </div>
        ...
        <div className="aap-stat-card">
          <div className="aap-stat-icon">
            <i className="fas fa-check-circle" style={{color: "var(--white)"}}></i>
          </div>
          <div className="aap-stat-content">
            <h3>
        ...
        <div className="aap-stat-card">
          <div className="aap-stat-icon">
            <i className="fas fa-check-double" style={{color: "var(--white)"}}></i>
          </div>
          <div className="aap-stat-content">
            <h3>
